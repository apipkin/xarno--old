...
Y.namespace('Xarno').Calendar = Y.Base.create('calendar', Y.Widget, [Y.WidgetStdMod], {
    ...
    initializer: function (config) {
        ...
        this.publish(EVENT_UPDATE, {
            defaultFn: this._defUpdateFn
        });
        this.publish(EVENT_SELECT, {
    ...
    _defUpdateFn: function (e) {
        ...
        if (selected) {
            ...
            de.setDate(0); // last day of current month
    ...
    ATTRS: {
         ...
         * @default <li class="day day-{count}"><a class="liner">{count}</a></li>
         * @since 1.0.0
         */
        dayTemplate: {
         ...
         * @default <li class="day previous previous-day-{count}"><span class="liner">{count}</span></li>
         * @since 1.0.0
         */
        previousDayTemplate: {
         ...
         * @default <li class="day next next-day-{count}"><span class="liner">{count}</span></li>
         * @since 1.0.0
         */
        nextDayTemplate: {
