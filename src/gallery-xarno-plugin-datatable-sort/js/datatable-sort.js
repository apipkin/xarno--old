/**
Plugin allows sorting of Xarno Datatable by clicking the column headers.
Column settings of sortable="true|false" allows custom controls over which columns are sortable. All columns in the table are sortable by default after plugged.
Column setting of defDirection="asc|desc" allows custom control over which direction a column is sorted when first clicked. All columns are sorted ascending by default after plugged.

@author Anthony Pipkin
@module gallery-xarno-plugin-datatable-sort
@class Y.Xarno.Plugin.DTSort
@extends Plugin.Base
@version 1.3.0
*/
...
Y.namespace('Xarno.Plugin').DTSort= Y.Base.create('dt-sort', Y.Plugin.Base, [], {
    ...
    */
    ...
    /**
    Reverses the rows within the table
    @since 1.1.0
    @protected
    @method _reverseTable
    */
    ...
    ATTRS : {
        ...
        @since 1.1.0
        @attribute {String} ascClass
        @default yui3-type-control-s
        */
        ascClass : {
        ...
        @since 1.1.0
        @attribute {String} descClass
        @default yui3-type-control-n
        */
        descClass : {
        ...
        */
        ...
        @since 1.0.0
        @attribute {String} sortDirection
        @default null
        */
        direction : {
            setter : function (val) {
