...
@class Y.Xarno.Notify
@module gallery-xarno-notify
@version 1.3.0
*/
...
/**
@author Anthony Pipkin
@class Y.Xarno.Notify.Message
@submodule gallery-xarno-notify-message
@version 1.3.0
*/
/**
...
Y.namespace('Xarno').Notify = Notify;
Y.Xarno.Notify.Message = Message;