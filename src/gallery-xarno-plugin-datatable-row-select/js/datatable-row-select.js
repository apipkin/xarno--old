...
* @module gallery-xarno-plugin-datatable-row-select
* @class Y.Xarno.Plugin.DTRowSelect
* @extends Plugin.Base
* @version 1.3.0
*/
...
Y.namespace('Xarno.Plugin').DTRowSelect = Y.Base.create('datatable-row-select', Y.Plugin.Base, [], {
    ...
    */
    ...
    ATTRS : {
        ...
        @attribute {Y.ArrayList} selectedRows
        @default {Y.ArrayList}
        */
        selectedRows : {
        ...
        /**
        Specifies if more than one row can be selected at a time
        ...
        */
        ...
        /**
        Specifies if clicking a selected row will turn it off
        @attribute {Boolean} toggleSelect
        @default true
        */
        toggleSelect : {
            value : true
